 ...
 *
 * @author Kevin.yuan
 * @since 2021-02-26 11:14:18
 */

@Data
@ApiModel(value = "OrgCustQueryParam", description = "客户")
public class OrgCustQueryParam {
    private static final long serialVersionUID = -84490699216136097L;
    /**
     * 记录唯一ID
     */
